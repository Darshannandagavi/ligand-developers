      ...
      <div className="content-section">
        ...
        <div className="step">
          ...
          <div className="image-placeholder">
            <img src='/c5Picture1.png' alt=""/>
          </div>
          <div className="image-placeholder">
            <img src='/c5Picture2.png' alt=""/>
          </div>
        </div>
        ...
        <div className="step">
          ...
          <div className="image-placeholder">
            <img src='/c5Picture3.png' alt=""/>
          </div>
          <div className="image-placeholder">
            <img src='/c5Picture4.png' alt=""/>
          </div>
        </div>
