...
const ManageTeachers = () => {
  ...
  const loadTeachers = async () => {
    try {
      setLoading(true);
      const res = await axios.get("https://ligand-dev-7.onrender.com/api/teacher",{},{withcredentials:true});
  ...
  const toggleStatus = async (id, currentStatus, teacherName) => {
    try {
      await axios.post(`https://ligand-dev-7.onrender.com/api/teacher/toggle-status/${id}`);
