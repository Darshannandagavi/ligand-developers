...
export default function ManageExam() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingExamId) {
        await axios.put(
          `https://ligand-dev-4.onrender.com/api/exams/${editingExamId}`,
          sanitizedData
        );
      } else {
        await axios.post("https://ligand-dev-4.onrender.com/api/exams", sanitizedData);
      }
  ...
  const deleteExam = async (id) => {
    if (window.confirm("Are you sure you want to delete this exam?")) {
      try {
        await axios.delete(`https://ligand-dev-4.onrender.com/api/exams/${id}`);
        fetchExams();
      } catch (err) {
        console.error(err);
      }
  ...
  const updateExamVisibility = async (id, visibility) => {
    try {
      ...
      await axios.put(`https://ligand-dev-4.onrender.com/api/exams/${id}`, {
        ...exam,
        visibility,
      });
      fetchExams();
                    ...
                    <div className="toggle-switch">
                      <input
                        ...
                        onChange={async (e) => {
                          try {
                            await axios.put(
                              `https://ligand-dev-4.onrender.com/api/exams/${exam._id}/show-result`,
