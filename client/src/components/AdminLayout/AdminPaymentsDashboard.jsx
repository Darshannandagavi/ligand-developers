...
//     (async () => {
//       try {
//         const res = await axios.get('https://ligand-dev-4.onrender.com/api/attendance/options/batches', { params: { collegeName: filters.collegeName }, headers: { Authorization: token ? `Bearer ${token}` : '' } });
...
//     (async () => {
//       try {
//         const res = await axios.get('https://ligand-dev-4.onrender.com/api/attendance/options/programs', { params: { collegeName: filters.collegeName, batch: filters.batch }, headers: { Authorization: token ? `Bearer ${token}` : '' } });
...
//     (async () => {
//       try {
//         const res = await axios.get('https://ligand-dev-4.onrender.com/api/attendance/options/technologies', { params: { collegeName: filters.collegeName, batch: filters.batch, programName: filters.programName }, headers: { Authorization: token ? `Bearer ${token}` : '' } });
...
//     try {
//       setLoading(true);
//       const res = await axios.get('https://ligand-dev-4.onrender.com/api/fee-groups/installments/summary', { params: filters, headers: { Authorization: token ? `Bearer ${token}` : '' } });
//       setSummary(res.data);
//     } catch (err) {
//       console.error(err);
