...
export default function AdminPaymentsDashboard() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await axios.get('https://ligand-dev-7.onrender.com/api/attendance/options/batches', { params: { collegeName: filters.collegeName },});
        setBatchOptions(res.data || []);
      } catch (err) { setBatchOptions([]); }
    })();
  }, [filters.collegeName]);
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await axios.get('https://ligand-dev-7.onrender.com/api/attendance/options/programs', { params: { collegeName: filters.collegeName, batch: filters.batch }, });
        setProgramOptions(res.data || []);
      } catch (err) { setProgramOptions([]); }
    })();
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await axios.get('https://ligand-dev-7.onrender.com/api/attendance/options/technologies', { params: { collegeName: filters.collegeName, batch: filters.batch, programName: filters.programName }, });
        setTechnologyOptions(res.data || []);
      } catch (err) { setTechnologyOptions([]); }
    })();
  ...
  const load = async () => {
    try {
      setLoading(true);
      const res = await axios.get('https://ligand-dev-7.onrender.com/api/fee-groups/installments/summary', { params: filters, });
      setSummary(res.data);
    } catch (err) {
      console.error(err);
      alert('Error loading summary');
