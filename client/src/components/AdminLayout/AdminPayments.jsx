...
//     (async () => {
//       try {
//         const res = await axios.get('https://ligand-dev-4.onrender.com/api/attendance/options/batches', { 
//           params: { collegeName }, 
...
//     (async () => {
//       try {
//         const res = await axios.get('https://ligand-dev-4.onrender.com/api/attendance/options/programs', { 
...
//     (async () => {
//       try {
//         const res = await axios.get('https://ligand-dev-4.onrender.com/api/attendance/options/technologies', { 
...
//     try {
//       const res = await axios.get('https://ligand-dev-4.onrender.com/api/attendance/students', { 
...
//       const res = await axios.get('https://ligand-dev-4.onrender.com/api/fee-groups/installments/summary', { 
//         params: { collegeName, batch, programName, technology }, 
//         headers: { Authorization: token ? `Bearer ${token}` : '' } 
//       });
...
//     }
//     try {
//       await axios.post('https://ligand-dev-4.onrender.com/api/fee-groups', { 
  ...
  useEffect(() => {
    const fetchTeachers = async () => {
      try {
        ...
        const response = await axios.get('https://ligand-dev-4.onrender.com/api/teacher', {
          headers: { 
  ...
  const saveGroup = async () => {
    ...
    try {
      ...
      const updatePromises = [...selected].map(studentId => 
        axios.put(`https://ligand-dev-4.onrender.com/api/users/${studentId}`, {
          teacher: selectedTeacher
        }, {
          headers: { Authorization: token ? `Bearer ${token}` : '' }
        })
